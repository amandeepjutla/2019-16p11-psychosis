...
SVIP_CLEAN <- "../data/clean/Simons_VIP__16p11.2_Dataset_v10.0"
SVIP_RAW <- "../data/raw/sops.csv"
...
source("2_derive_ados_domain_css.r") 

# Derive index of positive psychotic symptoms
source("3_derive_psychosis_index.r") 

# Create groups for regressions
source("4_create_analysis_groups.r")

# Run analyses and save data as series of CSV files
source("5_run_analyses.r")